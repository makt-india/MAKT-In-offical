...
// Updated data array with "Website Development" added
const SERVICES_DATA = [
  {
    id: 1,
...
export default function SpecializedServicesSlider() {
  ...
  return (
    <section className="relative py-16 md:py-24 bg-[#030712] text-white overflow-hidden flex flex-col items-center border-t border-indigo-900/30">
      ...
      <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-indigo-600/20 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute -bottom-40 -right-40 w-[500px] h-[500px] bg-cyan-500/20 blur-[120px] rounded-full pointer-events-none" />
      ...
      <style>{`
        ...
        /* Dark overlay on active slide so text remains readable */
        ...
        /* UPGRADE: Mobile View Fixes */
        @media (max-width: 768px) {
          .slider-container {
            height: 550px; 
          }
          
          /* Darker gradient on mobile to ensure text readability over images */
          .slider-item:nth-child(2)::after {
            background: linear-gradient(to right, rgba(3, 7, 18, 0.95) 0%, rgba(3, 7, 18, 0.8) 65%, rgba(3, 7, 18, 0.3) 100%);
          }

          /* Shift text content slightly up */
          .slider-content { 
            left: 24px; 
            width: calc(100% - 48px); 
            top: 35%; 
          ...
          /* Align thumbnails to the bottom right */
          ...
          {items.map((item) => (
            ...
            >
              <div className="slider-content">
                ...
                {/* Updated Button to match Cyan/Indigo Theme */}
